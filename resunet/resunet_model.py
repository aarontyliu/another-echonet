...
from .resunet_parts import LevelBlock, UpSamplingConcatenate


class ResUNet(nn.Module):
    def __init__(self, n_channels, n_classes, activation="relu"):
        ...
        self.level2 = LevelBlock(64, 128, stride=(2, 1), activation=self.activation)
        self.level3 = LevelBlock(128, 256, stride=(2, 1), activation=self.activation)
        self.level4 = LevelBlock(256, 512, stride=(2, 1), activation=self.activation)
        self.level5 = LevelBlock(512, 256, stride=(1, 1), activation=self.activation)
        self.level6 = LevelBlock(256, 128, stride=(1, 1), activation=self.activation)
        self.level7 = LevelBlock(128, 64, stride=(1, 1), activation=self.activation)
